...
double psi_from_aread(int aread) {
  ...
  int aread_40 = 0;
  switch (DEVICE_ADDR) {
    case 11: //used, inlet outlet switched
      aread_0 = 680;
      aread_40 = 2240;
      break;
    case 12: //used, inlet outlet switched
      aread_0 =830;
      aread_40 = 2400;
      break;
    case 13: //used
      ...
      aread_40 = 1860;
      break;
    case 14: //used, inlet outlet switched
      aread_0 = 780;
      aread_40 = 2360;
      break;
    case 15: //used, inlet outlet switched
      aread_0 = 180;
      aread_40 = 1426;
      break;
    case 16: //used 
...
void loop() {
  ...
  if (enable_serial_print && millis() - prev_timestamp > 10) {
    ...
    DEBUG_Serial.print(psi_inside);
    DEBUG_Serial.print(", ");
    DEBUG_Serial.print("raw:");
    DEBUG_Serial.println(analogRead(p_sense));
...
void rs485_send(const char* msg){
  digitalWrite(re_de, HIGH);   // enable transmit on RS-485 transceiver
  delayMicroseconds(5);
  RS485_Serial.print(msg);
  RS485_Serial.flush();        // wait until bytes are actually sent
  delayMicroseconds(5);
  digitalWrite(re_de, LOW);    // back to receive mode
}
